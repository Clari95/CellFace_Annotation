    ...
    <v-row fill-width>
      <v-row class="mx-auto mt-4 main">
        <v-col dense class="column">
              ...
              <v-container>
                <v-row dense>
                  <v-col cols="12">
                    <v-img
                      style="opacity: 0.8"
                      :aspect-ratio="16 / 2" src="../assets/CellsBlue.jpg">
                      <div
                        class="
                          display-1 white--text"
                      >
          ...
          <v-row dense>
            <div class="justify-center">
              <v-card color="grey lighten-4" height="130" width="590">
                <v-img
                  style="opacity: 0.8"
                  :aspect-ratio="16 / 1" src="../assets/symbolbild1.jpg">
                <div
                    class="
                      display-1 white--text"
                  >
        ...
        <v-col cols="4">
          <v-container>
            <v-row dense>
              <v-col cols="12">
                <v-img
                  style="opacity: 0.7"
                  :aspect-ratio="16 / 2" src="../assets/Cellsteal.jpg">
                  <div
                    class="
                      display-1 white--text"
                  >
              ...
              <v-col v-for="(item3, i) in item3" :key="i" cols="12">
                <v-card :color="item3.color" :height="item3.height">
                  <div class="flex-no-wrap justify-space-between">
                    <div>
                      <v-card-title
          ...
          <v-dialog v-model="dialog3" justify="center" width="800">
            <v-card width="800" justify="center">
              <v-card-title class="headline teal lighten-2" primary-title>{{
                dialog3_text
              }}</v-card-title>

              <v-card-text v-if="text_card !== 'points'" style="font-size: 1em">
                <br />
                <b>{{ text_card }}</b>
              </v-card-text>
              <v-card-text v-else style="font-size: 1em">
                <br />
                <b>How to get points:
                  <v-list>
                    <v-list-item> label cell: 10 points (from beginning)</v-list-item>
                    <v-list-item> label regions: 30 points (available from level 2)</v-list-item>
                    <v-list-item> add regions: 50 points (starts from level 3)</v-list-item>
                    <v-list-item> extra points by good accuracy
                      (#labeled areas/#areas in image > 85%)
                      </v-list-item>
                  </v-list>
                </b>
              </v-card-text>
  ...
  data: () => ({
    ...
    item3: [
      ...
      },
      {
        ...
        text: 'why and how.',
        text_card:
          'Sometimes not all important parts are marked by the LabelMask. But this is necessary to assign a category to areas. With the function "Add objects" the user has the possibility to add new regions/objects of interest to the mask and to label them afterwards.',
        height: '115',
        width: '800',
      },
      {
