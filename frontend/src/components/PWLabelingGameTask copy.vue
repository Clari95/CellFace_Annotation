        ...
        <div class="canvas">
          ...
          <div id="contextMenu" class="context-menu text-center">
            <ul id="label">
              <li
                value="Cell"
                @click="colorSelect('red')"
                @contextmenu="colorSelect('red')"
              >
                Single Cell
              </li>
              <li
                ...
                value="Aggregates"
                @click="colorSelect('orange')"
                @contextmenu="colorSelect('orange')"
              >
                Aggregate
              </li>
              <li
                v-if="allProperties.currentLevel !== 1"
                value="Platelet"
                @click="colorSelect('#66ff33')"
                @contextmenu="colorSelect('#66ff33')"
              >
                Platelet
              </li>
              <li
              ...
              <li
                value="Other"
                @click="colorSelect('blue')"
                @contextmenu="colorSelect('blue')"
              >
                Other
              </li>
            </ul>
...
export default {
  ...
  methods: {
    ...
    showContextMenuRegion(x, y) {
      if (this.display_contextmenuRegion === false) {
        ...
        document
          .getElementById('label')
          .addEventListener('contextmenu', this.getRegionLabel);
      } else {
        this.hideContextMenu();
    ...
    uploadData(section) {
      ...
      HTTP.post(
        `label_level/${this.labelAreas}/${this.labelAreasRegion}/${number}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/${this.allProperties.currentLevel}/${this.allProperties.labelingApproach}`,
      )
        .then(async (response) => {
  ...
  mounted() {
    ...
    console.log(this.allProperties.numberImagesLevel);
