      ...
      <v-col class='mx-auto mt-0 main'>
          <v-row class='canvas-wrapper' v-if="bounce_nextLevel === false">
            ...
            <div class='canvas'>
              ...
              style="font-size:1.2em">
                <b class="teal--text">Level 4: Label 10 images <br/>
                  <p style="font-size:0.8em">Now all funtions are available
                    <br/>Try to label as accurate as possible
...
export default {
  ...
  methods: {
    ...
    updateComponent(event) {
      ...
      /* if (this.allProperties.points >= 100) {
        this.dialog = true;
      } */
    },
    /* playSound(file) {
    ...
    uploadData(section) {
      ...
      HTTP.post(
        ...
        console.log(`points in lelve4 ${points}`);
    ...
    uploadNewData() {
      ...
      HTTP.post(
        // 'http://localhost:3000/labelmask/'
        `newAreas/${this.newAreas}/${this.imageRef_num}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/4`,
      ).then(async (response) => {
        // this.newImage = response.data.image;
    ...
    updateScores(all, review) {
      ...
      console.log(`current imagenumber: ${this.imageRef_num}`);
      ...
      HTTP.post(
        `getAccuracy/${this.allProperties.labelingApproach}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/${this.allProperties.currentLevel}/${this.imageRef_num}`,
        ...
        const Scores = [this.imageRef_num, this.numberCells, this.numberRegions, wrongAreas,
          ...
          this.allProperties.points, response.data.accuracy, this.allProperties.currentLevel];
