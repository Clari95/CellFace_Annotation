  ...
  <!--<div class='wrapper'>-->
    <v-row fill-width>
          ...
          <v-row class='canvas-wrapper' v-if="bounce_nextLevel === false">
            <div class='options'  style="width: 170px">
              ...
              <v-divider
                class="mx-4"
              ></v-divider>
              <v-subheader class="pl-3 red--text" style="font-size:1.2em"><b>Modi:</b>
              </v-subheader>
            ...
            <div class='canvas'>
              ...
              style="font-size:1.2em">
                <b class="teal--text">Level 3: Practice to add regions ;) <br/>
                  <p style="font-size:0.8em">A new mode is available!
                    <br/> Help for adding new areas not recognized by the algorithm to LabelMask.
                  </p>
                  <p style="font-size:0.7em">(Maybe the slider on the left side
                    can help you to see small platelets better)</p></b>
                  </v-subheader>
      ...
      justify="center" @click="updateComponent('next'); checkLabels('last');">
            ...
            <!--<section>
                !--<transition name="bounce">
                  <img v-if="bounce" alt="SpecialStar"
                ...
                <transition name="bounce">
                  <img v-if="bounce" alt="flash"
                  @click="updateComponent('next'); checkLabels('last');"
                  :src='require(`../assets/${animation}.jpg`)'
                  width="600"
                  class="center"/>
                </transition>
            ...
            <v-card-text class="align-center">
              {{nextLevelText}}
              Click on the Star to reach th next level
            </v-card-text>-->
          </v-row>
      </v-col>
...
export default {
  ...
  methods: {
    ...
    // upload labels
    uploadData(section) {
      console.log('uploadData start 3');
      ...
      HTTP.post(
        ...
        `label_level/${this.labelAreas}/${this.labelAreasRegion}/${this.imageRef_num}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/3/${this.allProperties.labelingApproach}`,
      ).then(async (response) => {
    ...
    uploadNewData() {
      ...
      HTTP.post(
        // 'http://localhost:3000/labelmask/'
        `newAreas/${this.newAreas}/${this.imageRef_num}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/3`,
      ).then(async (response) => {
        // this.newImage = response.data.image;
    ...
    /* calAccuracyAverage() {
      ...
      console.log(accuracySpecified[0], accuracySpecified[2]);
