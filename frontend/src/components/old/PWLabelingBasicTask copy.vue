  ...
  methods: {
    ...
    getCellLabel(event) {
      if (this.startX !== '') {
        ...
        this.lastLabeledElementAll[this.imageRef_num - 1] = this.lastLabeledElement;
        console.log(this.lastLabeledElementAll);
        this.startX = '';
        this.startY = '';
    ...
    getRegionLabel(event) {
      ...
      if (this.init_rect !== '') {
        ...
        console.log('last element region');
        console.log(this.lastLabeledElementAll);
        this.init_rect = '';
        this.width_region = '';
        this.height_region = '';
    ...
    uploadData(section) {
      ...
      HTTP.post(
        ...
        `label/${this.labelAreas}/${this.labelAreasRegion}/${this.imageRef_num}/${this.allProperties.UserID}/${this.allProperties.dataset_typ}/0/${this.allProperties.labelingApproach}`,
      ).then(async (response) => {
    ...
    undo() {
      ...
      if (!this.disabled_modi && !this.disabled_measurement) {
        ...
        console.log(this.imageRef_num);
        if (this.lastLabeledElementAll[this.imageRef_num - 1][length - 1] === 'cell') {
          const currentData = this.labelAreasAll[this.imageRef_num - 1];
          ...
          this.numberCells = this.numberCells - 1;
        } else if (this.lastLabeledElementAll[this.imageRef_num - 1][length - 1] === 'region') {
    ...
    updateScores(tooltyp) {
      ...
      const Scores = [this.imageRef_num, this.numberCells,
        this.numberRegions, wrongAreas, this.addedAreas, this.seconds];
      ...
      HTTP.post(
        `updateScore/${tooltyp}/${this.allProperties.UserID}/${points}/${this.numberCells}/${this.numberRegions}/${this.minusPoints}/${this.addedAreas}/${this.seconds}/${this.imageRef_num}/${this.allProperties.dataset_typ}/${date}`,
      ).then(async (response) => {
